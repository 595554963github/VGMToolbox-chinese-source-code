                        ...
                        case 2:
                            ...
                            switch (bitrate)
                            {
                                ...
                                case 192:
                                    ...
                                    break;
                                default:
                                    throw new FormatException(String.Format("对于输入频率（{1}）和通道（{2}），不支持的比特率（{0}）无法获得AA3格式字符串.", bitrate.ToString(), frequency.ToString(), channels.ToString()));
                            }
                            break;
                        case 6:
                            switch (bitrate)
                            ...
                            break;
                        default:
                            throw new FormatException(String.Format("不支持的通道（{0}），对于输入频率（{1}），无法获取AA3格式字符串.", channels.ToString(), frequency.ToString()));
                    }
                    break;
                case 48000:
                    switch (channels)
                    ...
                    break;
                default:
                    throw new FormatException(String.Format("不支持的频率：{0}，无法获取AA3格式字符串.", frequency.ToString()));
            }
