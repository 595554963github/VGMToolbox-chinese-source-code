...
namespace VGMToolbox.format.iso
{
    ...
    public class XDvdFsFileStructure : IFileStructure
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            throw new ArgumentException("对象不是XDvdFs文件结构");
        }
    ...
    public class XDvdFsDirectoryStructure : IDirectoryStructure
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            throw new ArgumentException("对象不是XDvdFs目录结构");
        }
            ...
            int nonRawSectorSize)
        {
            ...
            {
                throw new FormatException(String.Format("在0x{0}处处理XDVDFS目录记录时出错", recordOffset.ToString("X8")), ex);
            }
        }
    }
}
