    ...
    public partial class Form1 : Form
    {
        ...
        */
        ...
        private void btnDatCreator_BuildDat_Click(object sender, EventArgs e)
        {
            ...
            if (checkDatafileCreatorInputs())
            {
                toolStripStatusLabel1.Text = "重建数据文件...";
        ...
        private bool checkDatafileCreatorInputs()
        {
            ...
            if (!(checkTextBox(tbDatCreator_Name.Text, "数据文件名称") &&
                checkTextBox(tbDatCreator_Description.Text, "描述") &&
                checkTextBox(tbDatCreator_SourceFolder.Text, "源目录") &&
                checkTextBox(tbDatCreator_OutputDat.Text, "目的地数据文件") &&
                checkFolderExists(tbDatCreator_SourceFolder.Text, "源目录")))
            {
                ret = false;
            }
        ...
        private bool checkRebuilderInputs()
        {
            ...
            if (checkTextBox(tbRebuilder_SourceDir.Text, "源目录") &&
                checkTextBox(tbRebuilder_DestinationDir.Text, "目的地数据文件") &&
                checkTextBox(tbRebuilder_Datafile.Text, "数据文件名称") &&
                checkFolderExists(tbRebuilder_SourceDir.Text, "源目录") &&
                checkFolderExists(tbRebuilder_DestinationDir.Text, "目的地数据文件") &&
                checkFileExists(tbRebuilder_Datafile.Text, "数据文件名称"))
            {

                if (tbRebuilder_SourceDir.Text.Trim().Equals(tbRebuilder_DestinationDir.Text.Trim()))
                {
                    MessageBox.Show("源目录不能与目标目录相同");
                    ret = false;
                }
            }
            else
        ...
        private void tbXsfSource_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "检查… 开始";
                             ...
                             RunWorkerCompletedEventArgs e)
        {
            if (e.Cancelled)
            {
                ...
                toolStripStatusLabel1.Text = "检查...已取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "检查...完成";
            }
        }
        ...
        private bool checkTextBox(string pText, string pFieldName)
        {
            ...
            {
                MessageBox.Show(String.Format("{0}不能为空.", pFieldName));
                ret = false;
            }
            return ret;
        }
        ...
        private bool checkFolderExists(string pPath, string pFolderName)
        {
            ...
            {
                MessageBox.Show(String.Format("{0}未找到.", pFolderName));
                ret = false;
            }
            return ret;
        }
        ...
        private bool checkFileExists(string pPath, string pFileName)
        {
            ...
            {
                MessageBox.Show(String.Format("{0}未找到.", pFileName));
                ret = false;
            }
            return ret;
        }
                                     ...
                                     RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup();
                toolStripStatusLabel1.Text = "重建… 取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "重建… 完成";
            }
                                    ...
                                    RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup();
                toolStripStatusLabel1.Text = "重建数据文件… 取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                ...
                toolStripStatusLabel1.Text = "重建数据文件… 完成";
            }
            this.Text = "VGMToolbox";
        }
                     ...
                     RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup();
                toolStripStatusLabel1.Text = "检查数据文件… 已取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "检查数据文件… 完成";
            }
            this.Text = "VGMToolbox";
        }
        ...
        private void btnHoot_AddInfo_Click(object sender, EventArgs e)
        {
            ...
            tbOutput.Text += "Hoot CSV 信息传输到XML数据文件完成.";
        }
        ...
        private void tbNSF_nsfe2m3uSource_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "NSFE到.M3U 转换… 开始";
                             ...
                             RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup(false);
                toolStripStatusLabel1.Text = "NSFE到.M3U 转换… 已取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "NSFE到.M3U 转换… 完成";
            }
        }
        ...
        private void tbGBS_gbsm3uSource_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "GBS .M3U 创建… 开始";
                             ...
                             RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup(false);
                toolStripStatusLabel1.Text = "GBS .M3U 创建… 已取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "GBS .M3U 创建… 完成";
            }
        }
                             ...
                             RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup(false);
                toolStripStatusLabel1.Text = "Hoot XML生成… 已取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "Hoot XML生成… 完成";
            }
        }
        ...
        private void tbHootXML_Path_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "Hoot XML生成… 开始";
        ...
        private void tbXsfPsf2Exe_Source_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "PSF2EXE… 开始";
                             ...
                             RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup(false);
                toolStripStatusLabel1.Text = "PSF2EXE… 取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "PSF2EXE…完成";
            }
        }
        ...
        private void tbNDS_SdatExtractor_Source_DragDrop(object sender, DragEventArgs e)
        {
            ...
            toolStripStatusLabel1.Text = "SDAT提取… 开始";
                     ...
                     RunWorkerCompletedEventArgs e)
        {
            ...
            {
                doCancelCleanup(false);
                toolStripStatusLabel1.Text = "SDAT提取… 取消";
                tbOutput.Text += "行动取消.";
            }
            else
            {
                lblProgressLabel.Text = String.Empty;
                toolStripStatusLabel1.Text = "SDAT提取… 完成";
            }
        }
