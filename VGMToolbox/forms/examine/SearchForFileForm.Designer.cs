namespace VGMToolbox.forms.examine
{
    partial class SearchForFileForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblDragNDrop.Text = "拖放目录到此处搜索.";
            // 
            // tbSource
            // 
            ...
            this.lblOutputFolder.Text = "输出文件夹（留空以提取到以存档文件命名的子文件夹）";
            // 
            // btnOutputDir
            // 
            ...
            this.cbExtract.Text = "提取文件（如果在存档中，同名文件将覆盖每个文件" +"ther)";
            ...
            this.lblSearchString.Text = "搜索字符串（每行一个）";
            // 
            // tbSearchString
            // 
