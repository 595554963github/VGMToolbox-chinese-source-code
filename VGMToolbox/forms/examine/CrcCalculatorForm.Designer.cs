namespace VGMToolbox.forms.examine
{
    partial class CrcCalculatorForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpSourceFiles.Text = "将文件放在此处";
            ...
            this.cbMoveDuplicates.Text = "将标准校验和重复项移动到子文件夹，如果找到.";
            ...
            this.checkForDuplicatesFlag.Text = "检查重复项并在输出中包含报告.";
            ...
            this.cbDoVgmtChecksums.Text = "包括VGMToolbox方法校验和";
            ...
            this.cbMoveVgmtDuplicates.Text = "将VGMToolbox方法校验和重复项移动到子文件夹，如果找到.";
