namespace VGMToolbox.forms.other
{
    partial class ExternalListFileRenamerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gbListFileFileNames.Text = "文件名大小";
            // 
            ...
            this.rbListFileTerminator.Text = "文件名有终止符(16进制值,不需要0x前缀.)";
            ...
            this.rbListFileStaticSize.Text = "文件名具有静态大小";
            ...
            this.gbFilesToRename.Text = "要重命名的文件";
            // 
            // cbKeepExtension
            // 
            ...
            this.cbKeepExtension.Text = "保留原始文件扩展名";
