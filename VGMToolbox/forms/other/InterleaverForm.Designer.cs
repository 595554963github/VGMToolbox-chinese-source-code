namespace VGMToolbox.forms.other
{
    partial class InterleaverForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpFillBytes.Text = "当文件大小不同时:";
            // 
            // rbNoFillBytes
            // 
            ...
            this.rbNoFillBytes.Text = "不要使用填充字节";
            ...
            this.lblFillBytes.Text = "(字节值: 00, FF, etc...)";
            // 
            // rbUseFillBytes
            // 
            ...
            this.rbUseFillBytes.Text = "使用填充字节:";
