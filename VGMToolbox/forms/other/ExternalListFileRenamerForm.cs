...
namespace VGMToolbox.forms.other
{
    public partial class ExternalListFileRenamerForm : AVgmtForm
    {
        ...
        {
            // set title
            this.lblTitle.Text = "外部列表文件重命名器";
            this.tbOutput.Text = "根据外部索引或头文件中包含的名称重命名文件目录.";
            this.btnDoTask.Text = "重命名文件";
        ...
        private bool validateAll()
        {
            ...
            if (this.comboListFileNameTextFormat.SelectedItem.Equals("代码页"))
            {
            ...
            {
                isValid &= AVgmtForm.checkTextBox(this.tbListFileTerminator.Text, "文件名终止符");
            }
        ...
        private void InitializeTextFormatComboBox()
        {
            ...
            this.comboListFileNameTextFormat.Items.Add("代码页");
