namespace VGMToolbox.forms.extraction
{
    partial class ExtractCdxaForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rbUseSilentBlockEof.Text = "使用静默块确定EOF";
            ...
            this.rbUseTrackEof.Text = "使用轨道结束标记确定EOF";
            ...
            this.cbDoTwoPass.Text = "使用双通道方法，如果将多个轨道提取到单个文件中，请使用此方法" +"即使静默帧设置等于1";
            ...
            this.cbFilterById.Text = "按块ID过滤（如果没有提取文件，则取消选中）";
            ...
            this.lblSilentBlocks.Text = "确定EOF的静默帧数，如果有多个轨道，则降低此值" +"被提取到一个文件中.";
            // 
            // silentFrameCounter
            // 
            ...
            this.cbPatchByte0x11.Text = "0x11处的补丁字节等于0x00(大多数玩家也需要).";
