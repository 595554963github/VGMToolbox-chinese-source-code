namespace VGMToolbox.forms.extraction
{
    partial class UnpackNintendoWadForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbUnpackU8Archives.Text = "解压所有提取的U8档案";
            ...
            this.rbExtractAllSections.Text = "提取所有块（内容、证书、票证、标题、页脚）";
            ...
            this.rbExtractDataOnly.Text = "仅提取内容";
