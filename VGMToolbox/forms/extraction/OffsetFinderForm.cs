...
namespace VGMToolbox.forms.extraction
{
    public partial class OffsetFinderForm : AVgmtForm
    {
        ...
        private void loadPresetsComboBox()
        {
            ...
            this.comboPresets.DataSource = SqlLiteUtil.GetSimpleDataTable(DB_PATH, "偏移量查找器", "偏移量查找器 文件名");
            this.comboPresets.DisplayMember = "偏移量查找器";
            this.comboPresets.ValueMember = "偏移量查找器 ID";
        }
