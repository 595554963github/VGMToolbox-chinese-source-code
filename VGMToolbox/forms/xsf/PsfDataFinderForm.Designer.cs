namespace VGMToolbox.forms.xsf
{
    partial class PsfDataFinderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbRelaxVbEof.Text = "放宽VB文件结束限制 (仅使用样品长度来确定文件结束)";
            ...
            this.cbVbStartAt0x00.Text = "VB 总是从0x00偏移开始(f更快，也可能跳过误报).";
            ...
            this.cbRenameSeq.Text = "根据最大VH/VB值命名 SEQ.";
            ...
            this.cbUseMinimum.Text = "音序上的最小尺寸";
