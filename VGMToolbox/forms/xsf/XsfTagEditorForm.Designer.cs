namespace VGMToolbox.forms.xsf
{
    partial class XsfTagEditorForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbGenerateTitleFromFilename.Text = "从文件吗生成标题";
            ...
            this.cbDeleteEmpty.Text = "从文件标签中移除您留空的字段.";
            ...
            this.cbAddToBatchFile.Text = "为更改文件中的所有值构建psfpoint.exe批处理文件.";
            ...
            this.cbRemoveBrackets.Text = "从标题中删除括号中的信息";
