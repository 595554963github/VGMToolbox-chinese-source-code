namespace VGMToolbox.forms.xsf
{
    partial class Psf2DataFinderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cb00ByteAligned.Text = "BD 数据始终从0x00偏移开始(更快，并且可以跳过误报).";
            ...
            this.cbReorderSqFiles.Text = "将SQ文件命名为最大HD值.";
