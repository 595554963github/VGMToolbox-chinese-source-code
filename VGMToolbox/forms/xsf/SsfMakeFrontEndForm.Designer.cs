namespace VGMToolbox.forms.xsf
{
    partial class SsfMakeFrontEndForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbTryAllCombinations.Text = "尝试音序和BIN的所有组合(适合寻找匹配项)";
            ...
            this.cbSeekData.Text = "忽略扩展，使用 eqext.py和tonext.py查找数据.将抓取EXB文件" +
                "如果可用，来自源路径. 确保EXB文件名与文件匹配 " +
                "包含音序/TONE数据.";
            ...
            this.cbMatchSeqBank.Text = "匹配序列库";
            ...
            this.lblMixerNumber.Text = "混音器编号";
            // 
            // lblMixerBank
            // 
            ...
            this.lblSequenceTrack.Text = "音序轨道";
            // 
            // lblSequenceBank
            // 
            ...
            this.lblSingleDspFile.Text = "单个DSP文件(可选)";
            // 
            // tbDspFile
            // 
            ...
            this.tbOutputFolder.Text = "我的Ssf文件夹";
            // 
            // btnBrowseSource
            // 
