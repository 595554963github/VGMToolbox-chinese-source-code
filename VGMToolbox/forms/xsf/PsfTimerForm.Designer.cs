namespace VGMToolbox.forms.xsf
{
    partial class PsfTimerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblSepIndexParameterLength.Text = "索引参数长度";
            // 
            // lblSepIndexOffset
            // 
            ...
            this.lblSepIndexOffset.Text = ".minipsfs的音序索引偏移量, 使用PSX偏移量。有关值PARA请参阅存根源";
            // 
            // tbSepIndexOffset
            // 
            ...
            this.cbLoopEntireTrack.Text = "循环整个轨道(这对于循环整个轨道的轨道很有用).";
            ...
            this.rbForceSepType.Text = "SEP类型";
            ...
            this.cbForce2Loops.Text = "为找到的所有循环强制2个循环 (不推荐，仅用于超时曲目)";
