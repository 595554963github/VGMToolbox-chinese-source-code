namespace VGMToolbox.forms.stream
{
    partial class PosFileCreatorForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rbLoopStartByteStringOffset.Text = "循环开始在";
            ...
            this.rbLoopStartRiffOffset.Text = "循环开始在";
            ...
            this.rbLoopStartOffset.Text = "循环开始是";
            ...
            this.rbLoopStartStatic.Text = "循环起始是一个静态值";
            ...
            this.grpLoopEnd.Text = "循环结束/循环长度";
            // 
            ...
            this.grpLoopEndLoopLength.Text = "选择循环结束或循环长度";
            // 
            // rbLoopLength
            // 
            ...
            this.rbLoopEndRiffOffset.Text = "循环结束在";
            ...
            this.rbLoopEndOffset.Text = "循环结束是";
            ...
            this.rbLoopEndStatic.Text = "循环结束是一个静态值";
            ...
            this.cbOptionsCreateM3u.Text = "创建播放列表";
            ...
            this.cbLoopShiftPredictShift.Text = "为批次预测移位";
            ...
            this.rbLoopShiftWavCompare.Text = "将循环结束与总WAV样本进行比较";
            ...
            this.rbLoopShiftStatic.Text = "循环移位";
            ...
            this.label3.Text = "文件掩码($B:基础,$E:扩展,*:通配符)";
            // 
            // tbOutputFileMask
            // 
            ...
            this.rbLoopEndByteStringOffset.Text = "循环结束在";
