            ...
            if (!String.IsNullOrEmpty(extractedSq))
            {
                ...
                if (psxSeq != null)
                {
                    ...
                    if (!String.IsNullOrEmpty(psxSeq.TimingInfo.Warnings))
                    {
                        ...
                        progressStruct.GenericMessage = String.Format("{0}{1}警告{2}    {3}", pPath, Environment.NewLine, Environment.NewLine, psxSeq.TimingInfo.Warnings);
