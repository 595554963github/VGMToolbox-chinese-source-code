...
namespace VGMToolbox
{
    public partial class Form2 : Form
    {
        ...
        private TreeNode buildXsfTreeNode()
        {
            ...
            /////////////////////////
            TreeNode xsf_Psf2SettingsUpdaterNode = new TreeNode("PSF2设置更新程序");
        ...
        private TreeNode buildExtractionTreeNode()
        {
            ...
            // Byte Remover
            TreeNode ext_ByteRemoverNode = new TreeNode("字节移除器");
            ...
            // VFS Extractor
            TreeNode ext_VfsExtractorNode = new TreeNode("虚拟文件系统(VFS)提取器");
            ...
            // ISO Extractor
            TreeNode ext_IsoExtractorNode = new TreeNode("ISO镜像/档案提取器");
            ...
            // COMMON ARCHIVES
            //----------------
            TreeNode ext_CommonArchivesNode = new TreeNode("CRIWARE通用档案");
            ...
            // ExtractAdxForm
            TreeNode ext_ExtractAdxNode = new TreeNode("CRI ADX提取器");
            ...
            // ExtractHCaForm
            TreeNode ext_ExtractHcaNode = new TreeNode("CRI HCA提取器");
            ...
            // OGG Extractor
            ///////////////////
            TreeNode ext_ExtractOggNode = new TreeNode("Xiph.Org OGG提取器");
            ...
            // WII WAD Unpacker
            ///////////////////
            TreeNode ext_UnpackWadNode = new TreeNode("任天堂WAD解包器");
            ...
            ///////////////////
            TreeNode ext_ExtractU8Node = new TreeNode("任天堂U8解包器");
        ...
        private TreeNode buildStreamTreeNode()
        {
            ...
            TreeNode stream_RootNode = new TreeNode("流工具");
            ...
            // XMA Converter
            TreeNode xmaConverterNode = new TreeNode("XMA转换器");
            ...
            ///////////
            // MPEG Demuxer
            TreeNode mpegDemuxNode = new TreeNode("视频解复用器");
            ...
            // POS File Maker
            TreeNode posFileMakerNode = new TreeNode(".POS文件制作器");
        ...
        {
            VGMToolbox.util.NodeTagStruct nodeTag = new VGMToolbox.util.NodeTagStruct();
            TreeNode other_RootNode = new TreeNode("其他");
            ...
            // INTERNAL RENAMER
            TreeNode internalRenamerNode = new TreeNode("内部重命名器");
            ...
            TreeNode externalRenamerNode = new TreeNode("外部重命名器");
