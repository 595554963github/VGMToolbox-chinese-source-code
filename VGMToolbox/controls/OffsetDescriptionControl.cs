...
namespace VGMToolbox.controls
{
    public partial class OffsetDescriptionControl : UserControl
    {
        ...
        public bool IsValid(string offsetLabel)
        {
            ...
            isValid &= AVgmtForm.checkTextBox(this.tbOffset.Text, offsetLabel + " 偏移量");
            isValid &= AVgmtForm.checkTextBox(this.comboSize.Text, offsetLabel + " 大小");
            isValid &= AVgmtForm.checkTextBox(this.comboByteOrder.Text, offsetLabel + " 字节顺序");
